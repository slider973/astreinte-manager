...
| `case_attribution.dart` | `CaseAttribution` | La même case, 28 px, quand le planning y a posé quelqu'un : fond, encre, contour et icône de `context.statuts.attribution(etat)`. Pointeur seulement, comme la densité dense. |
