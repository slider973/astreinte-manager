...
/// Un chemin absent de la liste ne précharge rien — c'est le cas de l'accueil,
/// dont les données sont déjà en route depuis le démarrage, et de tous les
/// écrans qui n'interrogent pas la base.
