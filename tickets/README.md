...
Priorités : P0 = nécessaire au MVP, P1 = MVP souhaitable, peut glisser en v1.1, P2 = uniquement à la demande d'une caserne (natif).

Canal principal : la PWA. Aucun ticket P0 ou P1 n'exige de simulateur ni d'émulateur ; la vérification se fait sur Chrome et sur téléphone avec la PWA installée.
...
005 Connexion OTP · 006 Invitations et onboarding · 032 Build web PWA et déploiement · 009 Gestion des membres · 010 Paramètres de la caserne · 007 Profil
...
024 Push web FCM (PWA) · 025 Edge send-notification · 015 Rappels de saisie · 026 Centre de notifications
...
029 Abonnement Stripe · 030 Mode suspendu · 031 Super-admin · 034 RGPD · 035 Tests bout en bout

### À la demande d'une caserne uniquement (P2)
036 Push natives iOS et Android · 033 Stores iOS et Android
