...
|---|---|---|---|---|
| 058 | [Lire l'adresse confirmée à la source, pas dans les métadonnées](in-progress/058-invitations-en-attente-adresse-confirmee.md) | P2 | 051 | — |
...
| 057 | [Le jeton d'appareil des notifications n'est pas branché sur l'oubli](done/057-jeton-appareil-hors-oubli.md) | P2 | 024 053 | — |
